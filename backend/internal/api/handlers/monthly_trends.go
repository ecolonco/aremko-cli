...
// FamilyCombinations proxies the Django family-combinations endpoint.
// Accepts ?months=N (default 24, max 36).
func FamilyCombinations(cfg *config.Config) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		result, err := client.GetFamilyCombinations(months)
		if err != nil {
